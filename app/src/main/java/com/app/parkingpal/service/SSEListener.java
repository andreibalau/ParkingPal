...
public class SSEListener extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        try {
            ...
            final SseEventSource sseEventSource = sseEventSourceFactory.createEventSource(new URI("http://192.168.1.2:8080/sse-news"));//TODO: Change ip with the server mechine ip
